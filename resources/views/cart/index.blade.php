@php use App\Helpers\ProductHelper; @endphp
<x-app-layout>
    <x-slot name="header">
        ...
        <div class="container">
            ...
            @if(session('cart'))
                <table class="table">
                    ...
                    @foreach(session('cart') as $id => $item)
                        @php
                            ...
                            $formattedPrice = ProductHelper::formatPrices(collect([$price]))->first();
                            $formattedTotalPrice = ProductHelper::formatPrices(collect([$totalPrice]))->first();
                        @endphp
                        <tr>
                            <td>{{ $product['name'] }}</td>
                ...
                <div class="text-right">
                    <strong>Total: {{ ProductHelper::formatPrices(collect([array_reduce(session('cart'), function($carry, $item) {
